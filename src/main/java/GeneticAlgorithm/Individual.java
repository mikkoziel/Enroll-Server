...
public class Individual {
    ...
    public Individual(Timetable timetable) {
        ...
        // Loop through groups
        for (Student student : timetable.getGroupsAsArray()) {
            // Loop through modules
            for (int moduleId : student.getModuleIds()) {
                // Add random time
                Timeslot randomTimeslot = timetable.getRandomTimeslot(moduleId);
                int timeslotId = randomTimeslot.getTimeslotId();
