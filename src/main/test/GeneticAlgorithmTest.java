...
class GeneticAlgorithmTest {
    ...
    public void testPreferences() {
        ...
        timetable.addPreference(3, 1, 2, 2); //  new DayAndHouDetails(5, LocalTime.of(11,00), LocalTime.of(12,30))
        timetable.addPreference(6, 1, 2, 1); // new DayAndHouDetails(5, LocalTime.of(11,00), LocalTime.of(12,30))
        timetable.addPreference(7, 1, 2, 5);
        timetable.addPreference(9, 1, 2, 6);
        timetable.addPreference(11, 1, 2, 7);
    ...
    @Test
    public void testClashesInPreferences() {
        TimetableGA tester = new TimetableGA();
        Timetable timetable = new Timetable();
        ...
        timetable.addPreference(1, 1, 2, 7);
        timetable.addPreference(4, 1, 2, 2);
        timetable.addPreference(5, 1, 2, 1);
        timetable.addPreference(8, 1, 2, 5);
        timetable.addPreference(9, 1, 2, 6);
        timetable.addPreference(11, 1, 2, 7);
